...
export default function GameProfilesPanel({
  ...
  return (
    <div className="space-y-6">
      ...
      {!hasValorant ? (
        <div className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.01] glass-strong p-6 flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:border-[#ff4655]/30">
          <div className="absolute top-0 right-0 -mr-16 -mt-16 h-36 w-36 rounded-full bg-[#ff4655] opacity-[0.03] blur-3xl" />
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#ff4655]/10 text-[#ff4655]">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <div>
              <h4 className="text-base font-semibold text-white">Valorant</h4>
              <p className="text-xs text-white/45">Integrate your Riot account and sync leaderboard ratings.</p>
            </div>
          </div>
          <button
            type="button"
            ...
            disabled={busy}
            className="w-full sm:w-auto shrink-0 rounded-xl bg-[#ff4655] px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-white shadow-[0_0_20px_rgba(255,70,85,0.2)] hover:shadow-[0_0_28px_rgba(255,70,85,0.4)] hover:bg-[#ff5d6a] transition-all disabled:opacity-50 cursor-pointer"
          >
            Add Valorant
          </button>
        </div>
      ...
      {!hasCs2 ? (
        <div className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.01] glass-strong p-6 flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:border-[#e65a23]/30">
          <div className="absolute top-0 right-0 -mr-16 -mt-16 h-36 w-36 rounded-full bg-[#e65a23] opacity-[0.03] blur-3xl" />
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e65a23]/10 text-[#e65a23]">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
              </svg>
            </div>
            <div>
              <h4 className="text-base font-semibold text-white">Counter-Strike 2</h4>
              <p className="text-xs text-white/45">Integrate your Steam profile and configure your CS2 ranks.</p>
            </div>
          </div>
          <button
            type="button"
            onClick={() => addGame("CS2")}
            disabled={busy}
            className="w-full sm:w-auto shrink-0 rounded-xl bg-[#e65a23] px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-white shadow-[0_0_20px_rgba(230,90,35,0.2)] hover:shadow-[0_0_28px_rgba(230,90,35,0.4)] hover:bg-[#ff6d37] transition-all disabled:opacity-50 cursor-pointer"
          >
            Add CS2
          </button>
        </div>
